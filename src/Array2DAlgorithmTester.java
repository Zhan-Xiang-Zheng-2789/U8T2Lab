...
public class Array2DAlgorithmTester
{
    ...
    {
        System.out.println("-------TEST CODE for isFound-----------");
        ...
        System.out.println("-------TEST CODE for countElementsWithSubstring-----------");
        ...
        System.out.println("-------TEST CODE for replaceEvensWithZero-----------");
        ...
        System.out.println("-------TEST CODE for sumForRow-----------");
        ...
        System.out.println("-------TEST CODE for sumForColumn-----------");
        ...
        System.out.println("-------TEST CODE for printNumberGrid-----------");
        ...
        System.out.println("-------TEST CODE for gridOfXandO-----------");
        ...
        System.out.println("-------TEST CODE for findStringsOfLength-----------");
